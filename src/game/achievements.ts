...
export const ACHIEVEMENTS: Achievement[] = [
  // ── Visibles ───────────────────────────────────────────────────────────────
  { id: 'first_steps', name: 'Premiers Pas', desc: 'Capture ton premier Pokémon', icon: '👣', stat: 'captures', target: 1, hidden: false,
    reward: { kind: 'title', id: 't_novice', name: 'Novice' } },
  { id: 'collector_50', name: 'Collectionneur', desc: 'Capture 50 Pokémon', icon: '📚', stat: 'captures', target: 50, hidden: false,
    reward: { kind: 'title', id: 't_collector', name: 'Collectionneur' } },
  { id: 'collector_200', name: 'Archiviste Confirmé', desc: 'Capture 200 Pokémon', icon: '🗄️', stat: 'captures', target: 200, hidden: false,
    reward: { kind: 'frame', id: 'f_silver', name: 'Cadre Argent' } },
  { id: 'kanto_done', name: 'Maître de Kanto', desc: 'Complète le Pokédex Kanto (151)', icon: '👑', stat: 'pokedex', target: 151, hidden: false,
    reward: { kind: 'title', id: 't_kanto_master', name: 'Maître de Kanto' } },
  { id: 'shiny_first', name: 'Anomalie Dorée', desc: 'Capture ton premier Shiny', icon: '✨', stat: 'shinies', target: 1, hidden: false,
    reward: { kind: 'background', id: 'bg_shiny', name: 'Fond Doré' } },
  { id: 'shiny_10', name: 'Chasseur de Shiny', desc: 'Capture 10 Shiny', icon: '🌟', stat: 'shinies', target: 10, hidden: false,
    reward: { kind: 'xpfx', id: 'fx_shimmer', name: 'Barre Scintillante' } },
  { id: 'streak_25', name: 'Sur une Lancée', desc: 'Atteins une streak de 25', icon: '🔥', stat: 'best_streak', target: 25, hidden: false,
    reward: { kind: 'frame', id: 'f_flame', name: 'Cadre Flamme' } },
  { id: 'expedition_10', name: 'Explorateur Aguerri', desc: 'Termine 10 Expéditions', icon: '🗺️', stat: 'expeditions', target: 10, hidden: false,
    reward: { kind: 'xpfx', id: 'fx_glow', name: 'Barre Brillante' } },
  { id: 'poker_5', name: 'Beau Joueur', desc: 'Gagne 5 parties de Poké-Poker', icon: '♠', stat: 'poker_wins', target: 5, hidden: false,
    reward: { kind: 'background', id: 'bg_casino', name: 'Fond Casino' } },
  { id: 'level_25', name: 'Vétéran', desc: 'Atteins le niveau 25', icon: '🎖️', stat: 'level', target: 25, hidden: false,
    reward: { kind: 'frame', id: 'f_gold', name: 'Cadre Or' } },
  { id: 'legendary_3', name: 'Touché par les Étoiles', desc: 'Capture 3 Légendaires', icon: '🌠', stat: 'legendaries', target: 3, hidden: false,
    reward: { kind: 'title', id: 't_star', name: 'Élu des Étoiles' } },

  // ── Cachés ───────────────────────────────────────────────────────────────
  { id: 'unlucky', name: 'Gros Poissard', desc: '5 Pokémon t\'ont fui d\'affilée', icon: '💀', stat: 'flees_streak', target: 5, hidden: true,
    reward: { kind: 'title', id: 't_unlucky', name: 'Gros Poissard' } },
  { id: 'shiny_dex_50', name: 'Perfectionniste', desc: 'Obtiens 50 Shiny différents', icon: '💎', stat: 'shiny_dex', target: 50, hidden: true,
    reward: { kind: 'background', id: 'bg_prism', name: 'Fond Prismatique' } },
  { id: 'whale', name: 'Baleine', desc: 'Cumule 1 000 000 de Coins', icon: '🐋', stat: 'coins_total', target: 1_000_000, hidden: true,
    reward: { kind: 'title', id: 't_whale', name: 'Baleine' } },
  { id: 'three_regions', name: 'Tour du Monde', desc: 'Débloque les 3 régions', icon: '🌍', stat: 'regions_unlocked', target: 3, hidden: true,
    reward: { kind: 'frame', id: 'f_world', name: 'Cadre Mondial' } },
  { id: 'pokebox_addict', name: 'Accro à la Box', desc: 'Ouvre 100 PokéBox', icon: '📦', stat: 'pokebox_opened', target: 100, hidden: true,
